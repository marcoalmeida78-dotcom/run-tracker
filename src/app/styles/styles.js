...
export const getStyles = (colors) => StyleSheet.create({
  ...
  skipOptionsRow: { flexDirection: 'row', marginBottom: 12 },
  skipOptionBtn: { flex: 1, backgroundColor: colors.COLOR_CARD_BG, paddingVertical: 8, paddingHorizontal: 6, borderRadius: 8, marginRight: 8, alignItems: 'center', borderWidth: 1, borderColor: colors.COLOR_DIVIDER },
  skipOptionBtnActive: { backgroundColor: colors.COLOR_PRIMARY, borderColor: colors.COLOR_PRIMARY },
  skipOptionText: { fontSize: 11, fontWeight: '700', color: colors.COLOR_SECONDARY },
  skipOptionTextActive: { color: colors.COLOR_ACCENT_TEXT },
